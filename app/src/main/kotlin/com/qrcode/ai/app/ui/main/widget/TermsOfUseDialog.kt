...
import com.qrcode.ai.app.databinding.LayoutDialogTermsBinding
import com.qrcode.ai.app.utils.Constants
import kotlin.math.min

class TermsOfUseDialog : DialogFragment() {
    private var binding: LayoutDialogTermsBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = LayoutDialogTermsBinding.inflate(inflater, container, false)
        isCancelable = false
        setupEvent()
        return binding?.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.let {
            ...
            it.webview.loadUrl(Constants.TERMS_OF_USE_LINK)
        }
    }
